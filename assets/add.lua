a = a .. "\n" .. generate("banip", "si", 1, "ip", "duration")
a = a .. "\n" .. generate("banname", "si", 1, "name", "duration")
a = a .. "\n" .. generate("bans", "", 0, nil)
a = a .. "\n" .. generate("banusgn", "ii", 1, "id", "duration")
...
a = a .. "\n" .. generate("hudtxt", "isiii", 5, "id", "text", "x", "y", "align")
a = a .. "\n" .. generate("hudtxt2", "iisiii", 6, "player", "id", "text", "x", "y", "align")
...
a = a .. "\n" .. generate("hudtxtmove", "iiiii", 5, "player", "id", "duration", "x", "x")
